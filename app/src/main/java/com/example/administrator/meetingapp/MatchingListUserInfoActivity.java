...
// 하트리스트의 나와 매칭에 성공한 이성의 정보 화면
public class MatchingListUserInfoActivity extends AppCompatActivity {

    private TextView nickname, kakaoID, age, blood, height, bodyType, area, job, personality, hobby, religion, smoking, alcohol;
    private String imageURL;
    CircleImageView profileImage;
    private String userNickname, userKakaoID, userAge, userBlood, userHeight, userBodyType, userArea, userJob, userPersonality, userHobby, userReligion, userSmoking, userAlcohol;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matching_list_user_info);
    ...
    private void matchingUserInfo() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_USER_INFO,
                            ...
                            if (success.equals("1")) {
                                ...
                                ImageRequest imageRequest = new ImageRequest(imageURL,
                                    ...
                                    public void onErrorResponse(VolleyError error) {
                                        Toast.makeText(MatchingListUserInfoActivity.this, "사진을 가져오지 못했습니다.", Toast.LENGTH_SHORT).show();
                                        error.printStackTrace();
                                    }
                                });
                                MySingleton.getInstance(MatchingListUserInfoActivity.this).addToRequestQue(imageRequest);

                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(MatchingListUserInfoActivity.this, "Error1 : 이성 정보를 불러오지 못했습니다.", Toast.LENGTH_LONG).show();
                        }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(MatchingListUserInfoActivity.this, "Error2 : 이성 정보를 불러오지 못했습니다." + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    public void onBackPressed() {
        startActivity(new Intent(MatchingListUserInfoActivity.this, HartListActivity.class));
        finish();
        super.onBackPressed();
    }
